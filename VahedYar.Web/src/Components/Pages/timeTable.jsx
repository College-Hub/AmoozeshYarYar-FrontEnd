                            ...
                            <section id="timeTableHelp" className="row custome-contaner-section">
                                <div className={"row"}>
                                    <article className="col-12">
                                        ...
                                        <p className="hit-message"><i className="bi bi-exclamation-circle"></i> لیستی از  پیش‌نمایش ها از هر جدول زمانی رو در پایین این بخش میتونی ببینی. این پیش‌نمایش ها دارای یکسری اطلاعات پایه برای نمایش هستن با کلیک بر روی آیکون  ( <i className="bi bi-chevron-down"></i> ) میتونی اطلاعات بیشتری از اون جدول زمانی بگیری.</p>
                                        <p className="hit-message"><i className="bi bi-exclamation-circle"></i> با کلیک  بر روی آیکون قلب ( <i className="bi bi-heart"></i> ) میتونی جدول زمانی موردعلاقت رو سیو کنی که اگه بعدا باز به سایت ما برگشتی بتونی ببینیش. ( برای فعال شدن این افزونه نیازه حساب کاربری بسازی! )</p>
                                    </article>
                                </div>
                            </section>
                            <section className="row custome-contaner-section row">
                                ...
                                <Accordion defaultActiveKey="0">
                                    {
                                        timeTables?.map((p, index) => index < 5 ? <Preview key={index} eventKey={index} Presentations={p} /> : null)
                                    }
                                </Accordion>
                            </section>
                            {
