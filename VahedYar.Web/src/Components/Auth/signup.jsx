...
const Signup = () => {
    ...
    const sumbitHandler = (event) => {
        ...
        if (!(clientsideErrors.phoneNumber || clientsideErrors.usename || clientsideErrors.firstName || clientsideErrors.rePassword || clientsideErrors.password || clientsideErrors.email) && (userInfo.email && userInfo.password && userInfo.rePassword && userInfo.phoneNumber && userInfo.firstName && userInfo.lastName)) {
